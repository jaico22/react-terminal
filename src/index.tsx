...
import { TerminalContextProvider as _TerminalContextProvider, TerminalContext } from "./contexts/TerminalContext";
...
export default {
  ...
  TerminalContext // THIS IS LITERALLY ALL I WANT. WHY IS IT NOT EXPORTED AHHHHHH
};
